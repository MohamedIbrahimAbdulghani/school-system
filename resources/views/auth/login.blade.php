...
<body class="antialiased text-slate-800 selection:bg-brand-blue selection:text-white">
    ...
    <div class="relative min-h-screen flex items-center justify-center bg-slate-900 overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-md w-full space-y-8 glass-card p-10 rounded-3xl shadow-2xl z-10 relative border border-white/20">
            ...
            @session('status')
                <div class="mb-4 text-sm font-bold text-brand-green bg-brand-green/10 backdrop-blur-sm p-4 rounded-2xl border border-brand-green/20 text-center flex items-center justify-center gap-2">
            ...
            <form method="POST" action="{{ route('login') }}" class="mt-8 space-y-6">
                ...
                <div class="space-y-5">
                    <div>
                        <label for="email" class="block text-sm font-bold text-slate-700 mb-2">{{ trans('auth.Email') }}</label>
                        <div class="relative">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <label for="password" class="block text-sm font-bold text-slate-700">{{ trans('auth.Password') }}</label>
                        </div>
                        <div class="relative">
                            <div class="absolute inset-y-0 {{ app()->getLocale() == 'ar' ? 'right-0 pr-4' : 'left-0 pl-4' }} flex items-center pointer-events-none">
