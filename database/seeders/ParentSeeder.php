...
class ParentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $my_parents->email = 'ibrahimabdulghani@yahoo.com';
        ...
        $my_parents->father_blood_type_id  =TypeBlood::all()->unique()->random()->id;
        ...
        $my_parents->mother_blood_type_id  =TypeBlood::all()->unique()->random()->id;
