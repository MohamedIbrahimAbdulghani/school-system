                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" name="exam_name_ar"  class="form-control" value="{{ $exam->getTranslation('name','ar') }}" >
                                            @error('exam_name_ar')
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" name="exam_name_en"  class="form-control" value="{{ $exam->getTranslation('name','en') }}">
                                            @error('exam_name_en')
                                            <div class="alert alert-danger alert-dismissible fade show" role="alert">{{ $message }}
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
