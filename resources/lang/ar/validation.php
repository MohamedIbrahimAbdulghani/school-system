...
return [
    ...
    */
    ...
    'files' => 'الملفات',
    'files_required' => 'من فضلك قم برفع ملف واحد على الأقل.',
    'files_array'    => 'يجب أن يكون الحقل عبارة عن ملفات متعددة.',
    'files_mimes'    => 'يسمح فقط برفع صور (JPG, JPEG, PNG) أو ملفات PDF.',
    'files_max'      => 'يجب ألا يزيد حجم كل ملف عن 2 ميجا.',
    /*
    |--------------------------------------------------------------------------
    | تخصيص أسماء الحقول
    |--------------------------------------------------------------------------
