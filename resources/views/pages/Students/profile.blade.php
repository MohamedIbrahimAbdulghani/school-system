                ...
                <div class="row">
                    <div class="col-lg-4 border-right">
                        <div class="p-3 text-center">
                            <div class="mb-4">
                                <img src="{{URL::asset('assets/images/student.png')}}" alt="avatar" class="rounded-circle" style="width: 150px; height: 150px; padding: 5px; background-color: #fff; border: 2px solid #e9ecef; box-shadow: 0px 4px 8px rgba(0,0,0,0.05);">
                            </div>
                            ...
                            <span class="px-3 py-2 mt-2 badge badge-success" style="font-size: 14px;">{{trans('student.student')}}</span>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="p-3">
                            ...
                            <form action="{{route('student.profile.update',$profile->id)}}" method="POST">
                                ...
                                <div class="mb-3 row align-items-center">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0 text-muted" style="font-weight: 600;">{{trans('student.student')}} (AR)</h6>
                                    </div>
                                    <div class="col-sm-9">
                                        <input type="text" name="name_ar" value="{{ $profile->getTranslation('name', 'ar') }}"
                                ...
                                <div class="mb-3 row align-items-center">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0 text-muted" style="font-weight: 600;">{{trans('student.student')}} (EN)</h6>
                                    </div>
                                    <div class="col-sm-9">
                                        <input type="text" name="name_en" value="{{ $profile->getTranslation('name', 'en') }}"
                                            class="form-control form-control-lg" style="background-color: #f8f9fa; border: 1px solid #e9ecef;">
                                    </div>
                                </div>
                                <hr class="my-3">
