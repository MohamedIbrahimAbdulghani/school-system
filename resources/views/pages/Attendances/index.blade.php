...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">{{trans('attendances.title_page')}}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="float-left pt-0 pr-0 breadcrumb float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">{{trans('attendances.title_page')}}</a></li>
                <li class="breadcrumb-item active">{{trans('attendances.attendance_list')}}</li>
            </ol>
        </div>
    </div>
</div>
